...
async def send_reminder(chat_data, bot: Bot, translator_hub: TranslatorHub):
    i18n = translator_hub.get_translator_by_locale(locale=chat_data.lang)
    try:
        await bot.send_message(
            chat_data.chat_id,
            i18n.schedule.message(),
...
async def job_send_messages_to_users(
    bot: Bot, translator_hub: TranslatorHub, session_pool: async_sessionmaker, timezone
):
