...
class TestStatisticsService:
    ...
    @pytest.fixture
    def service(self, context, word_management_service, stats_repo):
    ...
    @pytest.mark.asyncio
    async def test_get_statistics_description(self, service, stats_repo, context):
        ...
        context.i18n.stat.description.assert_called_once()
        assert result == context.i18n.error.no.stat()
